...
public class CourseSelect extends Activity {
    ...
    private class CrSelect extends AsyncTask<String, Void, Void> {
        private ProgressDialog pdia = new ProgressDialog(CourseSelect.this);
        ...
        protected void onPostExecute(Void aVoid) {
            ...
            if(json == null){
                ...
                if (validid == false) {
                    ...
                    ArrayAdapter<String> adapter = new ArrayAdapter<>(CourseSelect.this, android.R.layout.simple_list_item_1, courses_name);
                    ...
                    listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
                        ...
                        public void onItemClick(AdapterView<?> arg0, View arg1, int position, long arg3) {
                            if (isNetworkAvailable()) {
                                Intent intent = new Intent(CourseSelect.this, SelectSection.class);
