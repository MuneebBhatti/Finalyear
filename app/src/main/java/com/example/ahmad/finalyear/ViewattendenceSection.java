 ...
 */
public class ViewattendenceSection extends Activity{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.view_attendence_section);
    ...
    private class SectionSelect extends AsyncTask<String, Void, Void> {
        private ProgressDialog pdia = new ProgressDialog(ViewattendenceSection.this);
        ...
        if(json == null){
            ...
            if (validid == false) {
                ...
                pdia.dismiss();
                ArrayAdapter<String> adapter = new ArrayAdapter<>(ViewattendenceSection.this, android.R.layout.simple_list_item_1, sections_name);
                ...
                listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
                    ...
                    public void onItemClick(AdapterView<?> arg0, View arg1, int position, long arg3) {
                       if(isNetworkAvailable()) {
                           Intent intent = new Intent(ViewattendenceSection.this, StudentSearch.class);
